...
export default function ModuleDrawer() {
  ...
  return (
    <>
      <div className="fixed inset-0 z-40 bg-black/60 backdrop-blur-md transition-opacity pointer-events-none" />
      <button
        type="button"
      ...
      />
      <aside className="animate-drawer-in fixed right-0 top-0 z-50 flex h-full w-full max-w-md flex-col border-l border-white/[0.12] bg-[rgba(2,6,23,0.55)] shadow-[0_0_0_1px_rgba(167,139,250,0.1),-24px_0_80px_rgba(0,0,0,0.65)] backdrop-blur-3xl backdrop-saturate-150 pointer-events-auto">
        ...
        <div className="sidebar-content min-h-0 flex-1 overflow-y-scroll overflow-x-hidden px-6 py-5 scrollbar-thin scrollbar-thumb-slate-600 scrollbar-track-transparent hover:scrollbar-thumb-slate-500" style={{ scrollBehavior: 'smooth' }}>
